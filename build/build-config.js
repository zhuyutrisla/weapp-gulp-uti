...
gulp.task('dev', ['compile-css', 'compile-js', 'compile-json', 'compile-wxml', 'compile-image', 'auto']);

gulp.task('build', ['compile-css', 'compile-js', 'compile-json', 'compile-wxml', 'compile-image']);
